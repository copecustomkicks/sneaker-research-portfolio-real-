...
export const processes: ManufacturingProcess[] = [
  {
    ...
    procedureSummary:
      'A last is either sourced commercially or modeled digitally and fabricated. Key dimensions are established first using a standard vocabulary: stick length (the longest point-to-point distance at toe and heel), bottom length (measured on the last bottom with flexible tape), toe spring, heel lift, and a set of girths and widths — ball, waist, instep, and long/short heel girth measured around the last with flexible tape, and ball, waist, instep, and heel width measured across the last bottom. Everything downstream, including the pattern, is derived from this surface.',
    criticalVariables: [
      'Ball girth',
      'Waist girth',
      'Instep girth',
      'Heel girth (long and short)',
      'Ball, waist, instep, and heel width',
      'Stick length',
      'Bottom length',
      'Toe spring',
      'Heel lift',
    ...
    qualityChecks: [
      'Measure the finished last against the intended dimensions',
      'Confirm the surface is smooth enough to release cleanly',
      'Cut a paper last gauge marked with the critical dimensions, last size, and code number, and use it to check the sample last and confirm any later duplicates match exactly',
    ],
  ...
  },
  {
    ...
    procedureSummary:
      'The strobel board is stitched to the lasting margin of the upper with an overlock-type seam running around the full perimeter. The result is flexible and lighter than a board-lasted alternative. Strobel material is a tough, low-stretch fabric, and it is typically marked with straight printed lines before stitching — if those lines end up twisted or curved on the finished shoe, the strobel was rotated relative to the upper during lasting, a quick visual check for a construction error that would otherwise be hard to catch.',
    criticalVariables: ['Seam allowance', 'Stitch density', 'Board alignment to the upper centerline', 'Tension consistency', 'Rotation of the strobel relative to the upper'],
  ...
  },
  {
    ...
    name: 'Cemented construction (cold cement)',
    stage: 'sole-attachment',
    purpose:
      'Join the sole unit to the lasted upper using adhesive alone, with the outsole unit built as its own complete assembly beforehand. The dominant construction method in modern athletic footwear, also called cold cement construction.',
    requiredTools: ['Cement system', 'Press or clamps', 'Last (kept in the shoe during pressing)', 'Heating tunnel or oven for the sole unit'],
    inputs: ['Lasted upper with prepared margin', 'Prepared sole unit'],
    procedureSummary:
      'The upper and the sole unit are prepared in parallel, not built up on one another. The midsole and outsole get their own special primer and cement and are bonded to each other in a heating tunnel to form one complete sole unit before either ever touches the upper. Separately, the upper is steamed to soften it, pulled over the last, toe-lasted, and cooled so it shrinks tight to the last shape. Only once both halves are complete are they marked, cemented, and mated, then pressed while the last remains inside to hold the shape. Alignment must be right on the first attempt — a mated cement bond generally cannot be repositioned. After pressing, the assembled shoe is run through a cooling tunnel to set the glue while still on the last, then a de-lasting machine pushes the last out without wrinkling the upper, and the footbed and laces are added for final inspection, cleaning, and packing.',
    criticalVariables: ['Alignment', 'Press pressure and duration', 'Full-contact coverage', 'Cure time before removing the last', 'Midsole-to-outsole bond time in the heating tunnel'],
    commonDefects: ['Misaligned sole', 'Edge gapping', 'Voids where pressure did not reach', 'Delamination under flex', 'Wrinkled upper from de-lasting before the glue has set'],
  ...
  {
    id: 'vulcanized-construction',
    name: 'Vulcanized construction',
    stage: 'sole-attachment',
    purpose:
      'Attach the outsole to the lasted upper by building it up in uncured pieces and curing the whole assembly in an oven, rather than bonding a pre-made sole unit with cement. The alternative to cemented (cold cement) construction.',
    requiredTools: ['Aluminum last (must survive oven heat)', 'Uncured rubber foxing tape', 'Steel rack', 'Vulcanizing oven'],
    inputs: ['Lasted upper', 'Uncured rubber outsole components', 'Uncured rubber foxing tape', 'Molded rubber filler/midsole'],
    procedureSummary:
      'Unlike cold cement construction, the outsole is not built as a separate finished unit — its rubber components are attached to the lasted upper piece by piece while still uncured. A strip of uncured rubber foxing tape is wrapped around the base of the upper, overlapping onto both the upper and the outsole to seal the joint, with a rear seam added last to cover the overlap. Because the shoe goes into a vulcanizing oven for several hours to cure, the last must be aluminum — a wood or plastic last would not survive the heat. For the same reason, an EVA foam midsole cannot be used directly: the curing heat would destroy it, so vulcanized shoes commonly use a molded rubber filler material instead, one that is already about 90% pre-vulcanized so it stays formable enough to bond during the final cure without collapsing.',
    criticalVariables: [
      'Oven temperature and cure time',
      'Foxing tape overlap and seam placement',
      'No gaps in tape coverage before curing',
      'Last material (must tolerate oven heat)',
    ],
    commonDefects: ['Gaps in the foxing tape allowing separation', 'Over- or under-cured rubber', 'Midsole material degrading under cure heat if EVA foam was used by mistake'],
    safetyPrecautions: ['FLAGGED. Oven curing involves sustained high heat.', 'Uncured rubber components should be handled per the material safety data sheet.'],
    requiresSupervision: true,
    supervisionNote: 'Vulcanizing ovens and aluminum-last handling at oven temperature require training and an approved facility. Not planned for this project at prototype scale.',
    qualityChecks: ['Inspect tape coverage for gaps before curing', 'Confirm full cure with no soft or tacky spots after cooling'],
    relevanceToPrototype:
      'Documented for comparison against the intended cemented (cold cement) route. The equipment requirement (vulcanizing oven, aluminum last) puts this out of scope at this project’s scale.',
    understanding: 'reading',
    sourceIds: ['src-motawi-how-shoes-are-made'],
  },
  {
